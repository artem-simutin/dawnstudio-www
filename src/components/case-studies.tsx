...
> = (props) => {
  ...
  return (
    <motion.div
      className="w-full flex desktop:hidden border-border-secondary border rounded-xs oveflow-hidden bg-background-primary"
      animate={{
    ...
    >
      <motion.div
        ...
        animate={{
          width: props.active ? (isMobile ? "0px" : "160px") : "100%",
        }}
